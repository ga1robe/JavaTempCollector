...
class TempCollectorApplicationTests {
	...
	void testAvgTemp() {
		//clear sample data
		tempService.clear();
		tempService.addRecord(new TempRecord(LocalDate.now(),LocalTime.of(10, 0),"Kraków",10));
        tempService.addRecord(new TempRecord(LocalDate.now(),LocalTime.of(12, 0),"Kraków",20));
	...
	void testAvgNightTemp() {
		//clear sample data
		tempService.clear();
		tempService.addRecord(new TempRecord(LocalDate.now(),LocalTime.of(3, 0),"Chorzów",10)); //night
        tempService.addRecord(new TempRecord(LocalDate.now(),LocalTime.of(22, 0),"Chorzów",20)); //night
		tempService.addRecord(new TempRecord(LocalDate.now(),LocalTime.of(16, 0),"Chorzów",20)); //day
	...
	void testAvgDayTemp() {
		//clear sample data
		tempService.clear();
		tempService.addRecord(new TempRecord(LocalDate.now(),LocalTime.of(7, 0),"Kielce",10)); //day
        tempService.addRecord(new TempRecord(LocalDate.now(),LocalTime.of(10, 0),"Kielce",20)); //day
		tempService.addRecord(new TempRecord(LocalDate.now(),LocalTime.of(22, 0),"Kielce",20)); //night
